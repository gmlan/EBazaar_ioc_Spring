		...
		<ul class="nav navbar-top-links navbar-right">
			...
			<c:if test="${not LoggedIn.admin}">
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
					 	<li><a href=""><i class="fa fa-home fa-fw"></i>Online Purchase</a></li>
			...
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu dropdown-user">
					<c:if test="${not LoggedIn.admin}">
						<li><a href="myorder"><i class="fa fa-history fa-fw"></i>Order History</a></li>						
						<li><a href="myshoppingcart"><i class="fa fa-save fa-fw"></i>Saved Cart</a></li>
						<li class="divider"></li>
					</c:if>
